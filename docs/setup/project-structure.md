...
│   └── warpx_polywell/            # Importable package (installed via `poetry install`)
...
1. Field file generation via `src/warpx_polywell/bext` and `src/warpx_polywell/eext`
...
### `src/warpx_polywell/bext/make_collection.py`
...
### `src/warpx_polywell/eext/eext.py`
...
### `src/warpx_polywell/eext/methods.py`
...
### `src/warpx_polywell/utils/paths.py`
...
### `src/warpx_polywell/utils/cyl.py`
